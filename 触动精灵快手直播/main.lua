...
w,h = getScreenSize()
UINew("快手直播","运行脚本","退出脚本","uiconfig.dat",0,120,w*0.9,h*0.9,"255,231,186","255,231,186") --方式一，宽高为屏幕的 90%
...
--打开快手
function loadKuaishou()
	runToast("快手登录...")
	while 1 do
		if isFrontApp("com.smile.gifmaker") == 1 then
			runToast("当前运行快手...")
		end
		myIsFrontApp("com.smile.gifmaker")
	end
end
